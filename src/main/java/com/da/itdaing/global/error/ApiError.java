...
public class  ApiError {
    ...
    private ApiError(ErrorCode errorCode) {
        this.status = errorCode.getStatus().value();
        this.code = errorCode.getCode();
        this.message = errorCode.getMessage();
    }

    private ApiError(ErrorCode errorCode, List<FieldError> fieldErrors) {
        this.status = errorCode.getStatus().value();
        this.code = errorCode.getCode();
        this.message = errorCode.getMessage();
    ...
    private ApiError(ErrorCode errorCode, String customMessage) {
        this.status = errorCode.getStatus().value();
        this.code = errorCode.getCode();
