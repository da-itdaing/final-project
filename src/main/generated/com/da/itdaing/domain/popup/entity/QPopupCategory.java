...
public class QPopupCategory extends EntityPathBase<PopupCategory> {
    ...
    private static final long serialVersionUID = -2056323981L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPopupCategory popupCategory = new QPopupCategory("popupCategory");

    public final com.da.itdaing.domain.master.entity.QCategory category;
    ...
    public QPopupCategory(Class<? extends PopupCategory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new com.da.itdaing.domain.master.entity.QCategory(forProperty("category")) : null;
