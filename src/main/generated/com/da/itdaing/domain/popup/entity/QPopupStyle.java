...
public class QPopupStyle extends EntityPathBase<PopupStyle> {
    ...
    private static final long serialVersionUID = -2003101092L;
    ...
    public final com.da.itdaing.domain.master.entity.QStyle style;
    ...
    public QPopupStyle(Class<? extends PopupStyle> type, PathMetadata metadata, PathInits inits) {
        ...
        this.style = inits.isInitialized("style") ? new com.da.itdaing.domain.master.entity.QStyle(forProperty("style")) : null;
    }
