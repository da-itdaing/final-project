...
public class QPopupFeature extends EntityPathBase<PopupFeature> {
    ...
    private static final long serialVersionUID = 61208801L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPopupFeature popupFeature = new QPopupFeature("popupFeature");

    public final com.da.itdaing.domain.master.entity.QFeature feature;
    ...
    public QPopupFeature(Class<? extends PopupFeature> type, PathMetadata metadata, PathInits inits) {
        ...
        this.feature = inits.isInitialized("feature") ? new com.da.itdaing.domain.master.entity.QFeature(forProperty("feature")) : null;
