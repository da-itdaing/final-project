...
public class QUserPrefRegion extends EntityPathBase<UserPrefRegion> {
    ...
    private static final long serialVersionUID = 1498263132L;
    ...
    public final com.da.itdaing.domain.master.entity.QRegion region;
    ...
    public QUserPrefRegion(Class<? extends UserPrefRegion> type, PathMetadata metadata, PathInits inits) {
        ...
        this.region = inits.isInitialized("region") ? new com.da.itdaing.domain.master.entity.QRegion(forProperty("region")) : null;
