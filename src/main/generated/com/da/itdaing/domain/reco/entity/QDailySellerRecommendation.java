...
public class QDailySellerRecommendation extends EntityPathBase<DailySellerRecommendation> {
    ...
    private static final long serialVersionUID = 2021703619L;
    ...
    public final com.da.itdaing.domain.geo.entity.QZoneArea zoneArea;
    ...
    public QDailySellerRecommendation(Class<? extends DailySellerRecommendation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.zoneArea = inits.isInitialized("zoneArea") ? new com.da.itdaing.domain.geo.entity.QZoneArea(forProperty("zoneArea"), inits.get("zoneArea")) : null;
    }
