...
public class QEventLog extends EntityPathBase<EventLog> {
    ...
    private static final long serialVersionUID = -1540937111L;
    ...
    public final com.da.itdaing.domain.popup.entity.QPopup popup;

    public final com.da.itdaing.domain.user.entity.QUsers user;

    public final com.da.itdaing.domain.geo.entity.QZoneCell zoneCell;
    ...
    public QEventLog(Class<? extends EventLog> type, PathMetadata metadata, PathInits inits) {
        ...
        this.popup = inits.isInitialized("popup") ? new com.da.itdaing.domain.popup.entity.QPopup(forProperty("popup"), inits.get("popup")) : null;
        this.user = inits.isInitialized("user") ? new com.da.itdaing.domain.user.entity.QUsers(forProperty("user")) : null;
        this.zoneCell = inits.isInitialized("zoneCell") ? new com.da.itdaing.domain.geo.entity.QZoneCell(forProperty("zoneCell"), inits.get("zoneCell")) : null;
    }
